...
<%--				<C:out> 測試 param 內容 ${param}</C:out>--%>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" id="input_price" name="price" value="${b.price }" required="required" pattern="[1-9]+[0-9]*">
					</div>
				</div>
				<div class="form-group">
					<label for="input_intro" class="col-sm-1 control-label">介紹</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="input_intro" name="intro" value="${b.intro }" required="required" >
					</div>
				</div>
				<div class="form-group">
					<label for="input_stock" class="col-sm-1 control-label">庫存</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" id="input_stock" name="stock" value="${b.stock }" required="required" pattern="[1-9]+[0-9]*">
					</div>
				</div>
				<div class="form-group">
