...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (15, 'Leo Tolstoy, Anna Karenina (Rosamund Bartlett', '/picture/15-1.jpg', '/picture/15-1.jpg', '/picture/15-1.jpg', 300, '女性主義專題Ａ-本課程立意以「表演藝術」作為社會實踐與人文批判的教學策略，透過業界專業師資的引進，嘗試建立一套表演藝術教學實作教學系統，引導學生在藝術創作的實踐中， 提升自主學習能力並建立跨域合作方法。', 8, 1);
INSERT INTO `goods` VALUES (25, 'Classical mechanics by John R. Taylor', '/picture/25-1.jpg', '/picture/25-1.jpg', '/picture/25-1.jpg', 38, '力學- By analyzing classical mechanical systems with vector calculus and linear algebra, the main objective of this course is to prepare the students for more advanced physics courses. ', 10, 2);
...
INSERT INTO `goods` VALUES (55, '計算機概論(第四版)(Forouzan 4/e)', '/picture/55.jpg', '/picture/55.jpg', '/picture/55.jpg', 36, 'IM1001-* 計算機概論Ｉ本課程的主要目標在對大一同學介紹與資管領域相關與需要認識的電腦科技， 使同學對這些科技能有基本概念， 以做為未來各個相關課程的基礎。因此，本課程將提供廣度的多領域介紹。為達成上述目標，本課程內容包括：(1)介紹電腦的整體架構，以對電腦有整體概念。', 10, 4);
...
INSERT INTO `goods` VALUES (114, ' Mesoscale Meteorology in Midlatitudes , Mark', '/picture/114.jpg', '/picture/114.jpg', '/picture/114.jpg', 28, '本課程目的為介紹中尺度天氣現象, 並就各種不同的中尺度天氣系統, 說明它們的生成機制、內部的結構、物理與動力過程、維持機制等。透過專題報告的方式，幫助學生了解實際中尺度天氣個案。', 10, 6);
...
INSERT INTO `order` VALUES (76, 600, 2, 0, 1, 'vili', '1344444444', '美國', '2022-12-03 13:31:29', 2);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'admin@gmail.com', '$2a$10$FdNRmAeG9VTPy7.m7.CXmu5opagl1v876xqHS6n8dTW1/6SK1blra', '管理員', '1333333333', '美國', b'1', b'0');
INSERT INTO `user` VALUES (2, 'vili', 'vili@gmail.com', '$2a$10$duKyYeM3FEQ9z3IS9qxhlu71vRaCCQvePb0ZtkfJVsXgGiQY4Rsyq', 'vili', '1344444444', '美國', b'0', b'0');
INSERT INTO `user` VALUES (40, 'junting', '10355098@st.thsh.tp.edu.tw', '$2a$10$ve.S7jjICxHcrsZfGyW4CORQK1e77Dk0ySGWBm4khfqgsVnKwRrSi', '', '', '', b'0', b'0');
